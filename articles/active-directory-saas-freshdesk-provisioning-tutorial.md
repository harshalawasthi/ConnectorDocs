...
> [!NOTE] 
> As an added feature, the provisioning service supports Agent & Customer roles defined in FreshDesk, they can be selected in the **Select Role** dialog. These roles will be visible in the Azure portal after the provisioning service is enabled.
